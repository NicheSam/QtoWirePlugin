...
namespace QtoWirePlugin
{
    ...
    public sealed class QtoExcelSyncCompletedEventArgs : EventArgs
    {
        public QtoExcelSyncCompletedEventArgs(QtoExcelResult result, bool automatic)
        {
            Result = result;
            Automatic = automatic;
        }

        public QtoExcelResult Result { get; private set; }
