...
namespace QtoWirePlugin
{
    ...
    public static class QtoRibbon
    {
        ...
        public static void CreateRibbon()
        {
            if (!TryCreateRibbon())
            {
                WriteStatusMessage("\nQtoWirePlugin V0.8.1 ribbon is not ready. It will be created automatically when AutoCAD finishes loading.");
        ...
        private static void RibbonCreateTimerTick(object sender, EventArgs e)
        {
            ...
            {
                StopRibbonCreateTimer();
                WriteStatusMessage("\nQtoWirePlugin V0.8.1 could not create the ribbon. Run QTO_SHOW_UI after AutoCAD finishes loading.");
            }
        }
