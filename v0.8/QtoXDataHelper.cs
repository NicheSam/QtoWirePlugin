...
namespace QtoWirePlugin
{
    public static class QtoXDataHelper
    {
        ...
        public const string KeySystemCode = "SYSTEM_CODE";
        public const string KeyEquipmentTypeCode = "EQUIPMENT_TYPE_CODE";
        public const string KeyQtoId = "QTO_ID";
        public const string KeyObjectRole = "OBJECT_ROLE";
        public const string KeyQuantityBasis = "QUANTITY_BASIS";
        public const string KeyQtoUnit = "QTO_UNIT";
        public const string KeyFloor = "FLOOR";
        public const string KeyArea = "AREA";
        public const string KeySpace = "SPACE";
        public const string KeyBudgetGroup = "BUDGET_GROUP";
        public const string KeyBudgetItemKey = "BUDGET_ITEM_KEY";
        public const string KeyMappingStatus = "MAPPING_STATUS";
        public const string KeyReviewReason = "REVIEW_REASON";
        public const string KeySourceRule = "SOURCE_RULE";
        public const string KeyConduitType = "CONDUIT_TYPE";
        public const string KeyConduitSize = "CONDUIT_SIZE";
        public const string KeyTraySize = "TRAY_SIZE";
        public const string KeyQtoSyncId = "QTO_SYNC_ID";
        public const string KeyQtoSyncStatus = "QTO_SYNC_STATUS";
        public const string KeyQtoLastSyncAt = "QTO_LAST_SYNC_AT";
        public const string KeyQtoLastModifiedAt = "QTO_LAST_MODIFIED_AT";
        public const string KeyQtoSourceCatalogId = "QTO_SOURCE_CATALOG_ID";
        public const string KeyQtoCatalogVersion = "QTO_CATALOG_VERSION";
        public const string KeyQtoCopySourceId = "QTO_COPY_SOURCE_ID";
        public const string KeyQtoScopeKind = "QTO_SCOPE_KIND";
        public const string KeyQtoScopeValue = "QTO_SCOPE_VALUE";
        public const string KeyQtoScopeName = "QTO_SCOPE_NAME";
        public const string KeyQtoScopePriorityTicks = "QTO_SCOPE_PRIORITY_TICKS";
        ...
        public const string TypeQtoStatusLabel = "QTO_STATUS_LABEL";
        public const string TypeQtoReviewMarker = "QTO_REVIEW_MARKER";
        ...
        public const string ScopeKindFloor = "FLOOR";
        public const string ScopeKindSystem = "SYSTEM";
