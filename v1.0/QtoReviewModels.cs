...
namespace QtoWirePlugin
{
    ...
    public static class QtoReviewIssueType
    {
        ...
        public const string MissingCableType = "MissingCableType";
        public const string MissingConduitType = "MissingConduitType";
        public const string MissingOutletId = "MissingOutletId";
        public const string MissingJunctionBoxId = "MissingJunctionBoxId";
        public const string MissingOutletJunctionBox = "MissingOutletJunctionBox";
        public const string DuplicateOutletId = "DuplicateOutletId";
        public const string DuplicateJunctionBoxId = "DuplicateJunctionBoxId";
        public const string MissingWire = "MissingWire";
        public const string MultipleWires = "MultipleWires";
        public const string OutletReferenceMissing = "OutletReferenceMissing";
        public const string JunctionBoxReferenceMissing = "JunctionBoxReferenceMissing";
        ...
        public const string CatalogConflict = "CatalogConflict";
    ...
    public class QtoValidationTarget
    {
        ...
        public string JunctionBoxId { get; set; }
