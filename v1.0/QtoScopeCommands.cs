...
namespace QtoWirePlugin
{
    public partial class Commands
    {
        ...
        public void QtoScopeClear()
        {
            ...
            editor.WriteMessage("\nQTO_SCOPE_CLEAR: 已清除 " + result.ScopeCount.ToString("0") + " 個範圍框；重新套用 " + ToSingleLine(result));
        }
        ...
        public void QtoScopeDynamicOff()
        {
            ...
            QtoSyncCommandService.StopScopeTracking();
            if (document != null)
            {
                document.Editor.WriteMessage("\n樓層/系統範圍動態套用已關閉。");
            }
        ...
        [CommandMethod("QTO_SCOPE_MANAGER")]
        public void QtoScopeManager()
        {
            Document document = Application.DocumentManager.MdiActiveDocument;
